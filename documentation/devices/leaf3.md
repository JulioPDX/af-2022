...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF2 | Vlan4094 | 10.255.252.9 | Port-Channel1 |
...
| Ethernet4 | host2_Ethernet1 | *trunk | *10,100,150 | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_SPINE1_Ethernet4 | routed | - | 172.31.255.17/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_SPINE2_Ethernet4 | routed | - | 172.31.255.19/31 | default | 1500 | false | - | - |
...
| Port-Channel4 | host2_PortChannel | switched | trunk | 10,100,150 | - | - | - | - | 4 | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.1.7/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.168.54.7/32 |
...
| Vlan3010 |  Tenant_A  |  10.255.251.8/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.251.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.1.7:10010 | 10010:10010 | - | - | learned |
| 100 | 192.168.1.7:10100 | 10100:10100 | - | - | learned |
| 150 | 192.168.1.7:10150 | 10150:10150 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A | 192.168.1.7:11 | connected |
...
router bgp 65102
   ...
   !
   vlan 10
      rd 192.168.1.7:10010
      route-target both 10010:10010
      redistribute learned
   !
   vlan 100
      rd 192.168.1.7:10100
      route-target both 10100:10100
      redistribute learned
   !
   vlan 150
      rd 192.168.1.7:10150
